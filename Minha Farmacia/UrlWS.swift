...
//    private let porta = "80"
    ...
    func urlDeletaReceitaId(id: Int) -> String{
//        /deleta-receita/id-receita/{id}
        
        return "http://\(host):\(porta)\(rotaReceita)deleta-receita/id-receita/\(id)"
    }
